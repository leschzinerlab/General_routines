...
def setupParserOptions():
        ...
        parser.add_option("--micros",dest="micros",type="string",metavar="FILE",
                help="Path to micrographs (.mrc) if NOT phase flipping.")
	...
	parser.add_option("--phaseflip", action="store_true",dest="phaseFlip",default=False,
        ...
        parser.add_option("--ctf",dest="ctf",type="string", metavar="STRING",
                help="If phase-flipping - ctf_param.txt output file. Will be used for micrograph names and CTF values.")
...
if __name__ == "__main__":
	...
	cmd = 'proc2d %s %s inplace norm=0,1' %(params['output'],params['output'])
	subprocess.Popen(cmd,shell=True).wait()
